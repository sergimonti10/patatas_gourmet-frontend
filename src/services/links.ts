...
export const ORDERS_BASE_URL = `${API_BASE_URL}/api/orders`;
export const DOWNLOAD_PDF_BASE_URL = `${API_BASE_URL}/api/generate-invoice`;
export const AUTH_BASE_URL = `${API_BASE_URL}/api/`;
export const REVIEWS_BASE_URL = `${API_BASE_URL}/api/reviews`;
